...
/**
*/
public class TagValuesQuery extends org.agileclick.genorm.runtime.SQLQuery
	{
	private static final Logger s_logger = LoggerFactory.getLogger(TagValuesQuery.class.getName());
	
	public static final String QUERY_NAME = "tag_values";
	public static final String QUERY = "select distinct \"value\" from tag";
	...
	//===========================================================================
	public interface ResultSet extends GenOrmQueryResultSet<TagValuesData>
		{
	...
	private class SQLResultSet 
		...
		*/
		public List<TagValuesData> getArrayList(int maxRows)
			{
			ArrayList<TagValuesData> results = new ArrayList<TagValuesData>();
			int count = 0;
			...
			try
				...
				if (m_onFirstResult)
					{
					count ++;
					results.add(new TagValuesData(TagValuesQuery.this, m_resultSet));
					}
		...
		*/
		public TagValuesData getRecord()
			...
			try
				{
				ret = new TagValuesData(TagValuesQuery.this, m_resultSet);
				}
			catch (java.sql.SQLException sqle)
				{
				throw new GenOrmException(sqle);
	...
	public class Record implements GenOrmQueryRecord, Attributes
		...
		protected Record(java.sql.ResultSet rs)
			...
			if (m_serializable)
				...
				m_attrValues[0] = TagValuesQuery.this.m_formatter.toString(s_attributeNames[0], m_value);
